...
import { Group, PasswordInput, Stack, TextInput,Button, BackgroundImage, LoadingOverlay } from '@mantine/core';
...
const Login = () => {
  ...
  return (
    <BackgroundImage src="/img/codif.jpeg" className="h-screen w-full">
        ...
        <div className="my-auto">
          <div className="bg-white shadow-md rounded-md border w-8/12 mx-auto p-8">
            <div className="flex items-center justify-center">
              <img src="/img/logo_crousz.png" className="h-52 w-60" alt="logo" />
            </div>
          
            <div className="login-title flex items-center justify-center">
              <h2 className="text-green-500">E-CAMPUS ADMINISTRATION</h2>
            </div>
